...
기존 경쟁사 분석은 단순 검색 기반으로 수행되어  
근거 부족, 결과 불안정, hallucination 문제가 발생한다.

본 프로젝트는 이를 해결하기 위해  
브랜드의 시장 포지셔닝을 기준으로 경쟁사를 정의하고,  
전략 인사이트까지 생성하는 멀티스텝 AI 시스템을 구현했다.
...
- 브랜드 요약 및 특징 분석  
- 시장 포지션 정의 (가격대, 타겟, 전략)  
- 포지셔닝 기반 경쟁사 도출 (market_peers / direct_competitors)  
- 강점 / 약점 / 전략 리포트 생성  
